...
使用方法：
    python generate_pptx.py --input ./ppt_data.json --output ./output/presentation.pptx
...
# 跨平台编码兼容处理
if sys.stdout.encoding and sys.stdout.encoding.upper() in ('CP932', 'SHIFT_JIS', 'SHIFT-JIS'):
    import io
...
class PPTGenerator:
    ...
    def _set_dark_background(self, slide):
        ...
        fill.solid()
        fill.fore_color.rgb = RGBColor(0x0A, 0x0A, 0x12)  # #0a0a12 深色
